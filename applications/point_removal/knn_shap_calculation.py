...
# limit number of data points due to calculation problems
...
# calculate and save KNN-Shapley values
k = 6

start_time = time.time()
print("------------Start:", start_time)
deep_knn_values, *_ = old_knn_shapley(k, X_train_deep, X_test_deep, y_train_deep, y_test_deep)
np.savez_compressed('.../applications/point_removal/deep_features_knn_new.npz', knn=deep_knn_values)
