...
#  obtain and store deep features
...
for i in range(10):
    np.savez_compressed("../arrays/deep_features/denseblock_4/train/" + "df_" + str(i) + ".npz", x=deep_features_image[i * 15000:i * 15000 + 15000],
...
for i in range(10):
    np.savez_compressed("../arrays/deep_features/test/" + "df_" + str(i) + ".npz", x=deep_features_image[i * 3750:i * 3750 + 3750],
